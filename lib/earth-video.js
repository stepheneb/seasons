...
earthVideoStr += "<object id=\"flash_fallback_1\" class=\"vjs-flash-fallback\" width=\"640\" height=\"264\" type=\"application\/x-shockwave-flash\"";
...
earthVideoStr += "<param name=\"flashvars\" value='config={\"playlist\":[\"images/earth-frame1.jpg\", {\"url\": \"earth3.flv\",\"autoPlay\":false,\"autoBuffering\":true}]}' \/>";
earthVideoStr += "<img src=\"earth-frame1.jpg\" width=\"1030\" height=\"700\" alt=\"Poster Image\"";
earthVideoStr += "title=\"No video playback capabilities.\" \/>";
earthVideoStr += "<\/object>";
earthVideoStr += "<\/video>";
earthVideoStr += "<p class=\"vjs-no-video\">Playing a video of Earth visualization with the <a href=\"http:\/\/videojs.com\">HTML5 Video Player<\/a>";
earthVideoStr += " by VideoJS because this browser doesn't support WebGL.<\/p>";
earthVideoStr += "<\/div>";
earthVideoStr += "";
